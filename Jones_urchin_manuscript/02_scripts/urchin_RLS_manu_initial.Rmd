...
```
Appears to be some spatial autocorrelation.
...
```
There is still spatial autocorrelation.
...
Because we are seeing spatial autocorrelation in the fish sp richness glmms I will try to do this model with sdmTMB to get account for the spatial autocorrelation.
...
#gaussian, poisson, not good. nbinom1 and nbinom2 good
```
...
#gaussian, poisson, not good. nbinom1 and nbinom2 good, with a slight warning for nbinom1
```
