...
Resids look much improved to the model with fish and no site.
...
The best fitting model appears to be the simple glmm with no random effects and without the fish variable.
