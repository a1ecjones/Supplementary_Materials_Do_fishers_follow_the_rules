...
for (i in seq_len(P)) {
  ...
  fish_perm_test_stat_num[i] <- abs(mean(variable[perm_num][protected_index_num]) - mean(variable[perm_num][unprotected_index_num]))
}
